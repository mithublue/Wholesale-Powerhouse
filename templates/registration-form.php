		...
		<div class="wh-form-section">
			...
			<p class="wh-form-row">
				...
				<input type="text" name="wh_username" id="wh_username" required 
					   value="<?php echo isset( $_POST['wh_username'] ) ? esc_attr( sanitize_user( wp_unslash( $_POST['wh_username'] ) ) ) : ''; ?>" />
			</p>
			...
			<p class="wh-form-row">
				...
				<input type="email" name="wh_email" id="wh_email" required 
					   value="<?php echo isset( $_POST['wh_email'] ) ? esc_attr( sanitize_email( wp_unslash( $_POST['wh_email'] ) ) ) : ''; ?>" />
			</p>
		...
		<div class="wh-form-section">
			...
			<p class="wh-form-row">
				...
				<input type="text" name="wh_first_name" id="wh_first_name" 
					   value="<?php echo isset( $_POST['wh_first_name'] ) ? esc_attr( sanitize_text_field( wp_unslash( $_POST['wh_first_name'] ) ) ) : ''; ?>" />
			</p>
			...
			<p class="wh-form-row">
				...
				<input type="text" name="wh_last_name" id="wh_last_name" 
					   value="<?php echo isset( $_POST['wh_last_name'] ) ? esc_attr( sanitize_text_field( wp_unslash( $_POST['wh_last_name'] ) ) ) : ''; ?>" />
			</p>
		</div>
		...
		<div class="wh-form-section">
			...
			<p class="wh-form-row">
				...
				<input type="text" name="wh_company" id="wh_company" 
					   value="<?php echo isset( $_POST['wh_company'] ) ? esc_attr( sanitize_text_field( wp_unslash( $_POST['wh_company'] ) ) ) : ''; ?>" />
			</p>
			...
			<p class="wh-form-row">
				...
				<input type="text" name="wh_tax_id" id="wh_tax_id" 
					   value="<?php echo isset( $_POST['wh_tax_id'] ) ? esc_attr( sanitize_text_field( wp_unslash( $_POST['wh_tax_id'] ) ) ) : ''; ?>" />
